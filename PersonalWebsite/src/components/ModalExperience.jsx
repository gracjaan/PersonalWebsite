...
const ModalExperience = ({ openModal, setOpenModal }) => {
  ...
  return (
    <>
      ...
      <div className="bg-quaternary px-[120px] pt-20 fixed bottom-0 left-0 2xl:left-[50%] right-0 top-[92px] xl:top-[132px] 2xl:top-0 flex flex-col hidden z-50 rounded-t-3xl 2xl:rounded-none" id="modalexperience">
