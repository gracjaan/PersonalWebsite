    ...
    return (
        <div className="h-full w-full overflow-hidden bg-[#efefef]">
            <nav className="flex items-center justify-center">
                ...
                >
                    <img
                        src="./temp/icon/gracjan-icon.png"
                        layout="fill"
                        draggable={false}
                        alt="Topicon"
                    />
            ...
            <main>
                    ...
                    <div className="flex w-[800px] max-w-[800px] flex-col items-center justify-between gap-16 lg:flex-row lg:gap-0 xl:w-[1000px] xl:max-w-[1000px]">
                        <div className="flex flex-col gap-12">
                            ...
                            <motion.div
                                ...
                                className="flex h-[20rem] items-center justify-center gap-3"
                            >
                                ...
                                <div className="flex flex-col gap-4 text-[0.9rem] sm:text-lg">
                                    ...
                                    <p className="opacity-50 transition-opacity duration-300 hover:opacity-100">
                                        Oh, and I tick all those boxes: <strong>100-hour weeks</strong>, <br /> 
                                        <strong>top code contributor</strong>, <strong>10K+ fullstack hours</strong>, <br />
                                        and <strong>founding engineer experience</strong>. <br />
                                        <i>(check out my GitHub account, I push code 7 days a week)</i>
                                    </p>
                                    <p className="opacity-50 transition-opacity duration-300 hover:opacity-100">
                ...
                >
                    ...
                    <div className="flex gap-4">
                        ...
                        <ShadowButton href="https://www.gracjan.me/">
                            <MaskSvg
                ...
                <footer className="flex items-center justify-center gap-1 pb-12">
                    <p className="text-center font-[Roslindale] text-lg sm:text-2xl">
                        Made by <strong>Gracjan</strong>, for <strong>Kennan & Kevin & Max</strong>,
                        with
                    </p>
